<<<<<<< HEAD
DesktopAppConverter.exe -Installer C:\Users\mannd\git\epcalipers-windows\epcalipers\epcalipers-install\bin\x64\Release\epcalipers_install.msi  -Destination C:\Users\mannd\Documents\epcalipers-app\ -PackageName "epcalipers" -Publisher "CN=EP Studios" -Version 1.10.0.0 -MakeAppx -Verbose
=======
param (
    [string]$platform = "x86",
