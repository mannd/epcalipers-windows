...
electronic claipers to measure any image that is open on your Desktop.
...
| SHIFT+CTRL+R     | Rotate image 90° right     |
| SHIFT+CTRL+L     | Rotate image 90° left      |
| CTRL+0 (zero)    | Reset image rotation       |
| CTRL+=           | Zoom in                    |
| CTRL+-           | Zoom out                   |
| CTRL+T           | Add time caliper           |
| CTRL+A           | Add amplitude caliper      |
| CTRL+L           | Add angle caliper          |
